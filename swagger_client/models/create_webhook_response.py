...
class CreateWebhookResponse(object):
    ...
    def client_application_id(self):
        """Gets the client_application_id of this CreateWebhookResponse.  # noqa: E501

        The id of the partner's client application that owns the webhook  # noqa: E501

        :return: The client_application_id of this CreateWebhookResponse.  # noqa: E501
        :rtype: object
        """
    ...
    def client_application_id(self, client_application_id):
        """Sets the client_application_id of this CreateWebhookResponse.

        The id of the partner's client application that owns the webhook  # noqa: E501

        :param client_application_id: The client_application_id of this CreateWebhookResponse.  # noqa: E501
        :type: object
        """
    ...
    @property
    def url(self):
        """Gets the url of this CreateWebhookResponse.  # noqa: E501

        The url where the webhook events will be sent  # noqa: E501

        :return: The url of this CreateWebhookResponse.  # noqa: E501
        :rtype: object
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this CreateWebhookResponse.

        The url where the webhook events will be sent  # noqa: E501

        :param url: The url of this CreateWebhookResponse.  # noqa: E501
        :type: object
        """
